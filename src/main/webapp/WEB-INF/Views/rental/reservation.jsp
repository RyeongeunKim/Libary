...
<body>
	...
	<!-- action="reserveData" -->
	<form action="reserveData" method="post" id="ooo"  >
		아이디: <%=uID%> </p>
		
		예약가능 날짜: <input  id="rtDate" name="rtDate" value="${rtDate}" style="width:215px;height:45px;font-size:15px;"></p>
	
		예약할 책 이름: <input type="bn" id="bn" name="bn" value="${bn}" > </p>

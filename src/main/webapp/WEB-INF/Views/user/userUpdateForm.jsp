...
<body>
	...
	<form action="userUpdate" method="post" id="form" name="form" >
		...
		<div>
			<div>	
				이름 <input type="text" name="userName" id="userName"  value="${userData.userName}" placeholder="이름을 입력해주세요">	
			</div>
			<div>
		...
		<div>
			<div>	
				나이 <input type="text" name="userAge" id="userAge"  value="${userData.userAge }" placeholder="나이를 입력해주세요">	
			</div>
			<div>
		...
		<div>
			<div>	
				전화번호 <input type="text" name="userPhone" id="userPhone"  value="${userData.userPhone }" placeholder="'-' 제외">	
			</div>
			<div>
		...
		<div>
			<div>	
				주소 <input type="text" name="userAddress" id="userAddress"  value="${userData.userAddress }" placeholder="주소를 입력해주세요">	
			</div>
			<div>

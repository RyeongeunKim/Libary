...
<link href="${path}/resources/bootstrap/css/bookinfo2.css" rel="stylesheet">
	...
	<h1>책 정보 수정</h1><br/>
				...
				<main class="form-signin">
					...
					<input type="hidden" name = "bookID" value=<%=bookId%>>
						...
						<input class="w-100 btn btn-lg btn-primary" type="submit" value="확인" onclick="javascript: form.action='bookUpdate'">
